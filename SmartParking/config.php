...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($prenom) || empty($nom) || empty($email) || empty($password)) {
        ...
        $sql = "UPDATE `utilisateur` SET `prenom`='$prenom', `nom`='$nom', `email`='$email', `password`='$passwordHash', `jawaz_id`='$jawaz', `fidelite_id`='$fidelite', `matricule`='$matricule' WHERE `user_id` = '$id_utilisateur'";
