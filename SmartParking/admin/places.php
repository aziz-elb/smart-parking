...
<head>
    ...
    <style>
        ...
        .horizontal {
            ...
            width: 120px;
            /* wider for horizontal display */
            height: 60px;
            /* shorter height compared to the default */
            ...
            <div class="col-sm-12 col-md-8  ">
                <form method="post">
                    <div class="">
                        ...
                        <div class="d-flex shadow-none p-3 mb-5 mt-2  rounded justify-content-between align-items-center" style="background-color: #222222; color: #fff;">
                            <div class="p-2">
                                <h4 style="font-weight: 300;">Place disponible</h4> <!-- Dark green text -->
                            </div>
                            <div class="bg-white text-center p-2 rounded d-flex justify-content-center align-items-center" style="color: #222222; width: 50px; height: 50px;font-size:22px;">
                        ...
                        <div>
                            <div class="d-flex flex-row justify-content-between align-items-start">
                                <div class="row_A shadow-none p-1 m-1 bg-body-tertiary rounded d-flex flex-column ">
                                    ...
                                    while ($rowB = mysqli_fetch_array($resultB)) {
                                        ...
                                        <label class='custom-radio-tooltip'>
                                            <input class='vertical' type='radio' name='place' id='' value='{$rowB['place_id']}' $disabled style\"input[type='radio']{height: 105px;}\">
                                ...
                                <div class="row_C shadow-none p-1 m-1  bg-body-tertiary rounded d-flex flex-row">
                                    <div class="d-flex flex-column">
                                        ...
                                        while ($rowB = mysqli_fetch_array($resultB)) {
                                            ...
                                            echo "
                                        <label class='custom-radio-tooltip'>
                                            <input class='vertical horizontal' type='radio' name='place' id='' value='{$rowB['place_id']}' $disabled>
                                            <span class='tooltip-text'>{$rowB['emplacement']}<br>" . ($disabled ? "Occupée" : "Disponible") . "</span>
                                        </label>
                                        ";
                                        }
                                ...
                                <div class="row_D shadow-none p-1 m-1  bg-body-tertiary rounded d-flex flex-row">
                                    <div class="d-flex flex-column">
                            ...
                            <div class="row_B shadow-none p-1 m-1  bg-body-tertiary rounded d-flex justify-content-start">
                                ...
                                while ($rowB = mysqli_fetch_array($resultB)) {
                                    ...
                                    echo "
                               <label class='custom-radio-tooltip'>
                               <input class='vertical' type='radio' name='place' id='' value='{$rowB['place_id']}' $disabled>
                               <span class='tooltip-text'>{$rowB['emplacement']}<br>" . ($disabled ? "Occupée" : "Disponible") . "</span>
                               </label>
                               ";
                                }
